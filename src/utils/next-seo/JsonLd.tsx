...
const jsonData = {
  ...
  "description":"Desenvolvedor Front-End. Autodidata com bastante conhecimentos na área de desenvolvimento. HTML5, CSS3, JavaScript, ReactJS, Typescript, Git, GitHub e Figma.",
